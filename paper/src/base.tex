...
CTR if it is flagged as \texttt{stable} and \texttt{middle}.  As such, we
...
\emph{added} to a random CT log
	(see Section~\ref{sec:base:phase3}, step~\ref{enm:storage:fix-log}).
...
in hope that the log is available next auditing instance.
