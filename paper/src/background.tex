...
{\bf \color{red} This is not explicitly referred to anywhere later in
  the paper.}\\
The \texttt{get-proof-by-hash} endpoint takes as
...
omission and split-view attacks.
{\bf \color{red} Redundant with the first paragraph of Section~\ref{sec:background:ct}. Consolidate? Or accept that a little redundancy reinforces reader understanding?}\\
A party that follows-up on inclusion and
