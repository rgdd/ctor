...
Meaningful inclusion proof fetching requires that everyone observes the same
set of consistent STHs.
One option is to configure client software with a list of entities that they
should gossip with, e.g., CT monitors~\cite{chase}.
...
Syta~\emph{et~al.} proposed an alternative to reactive gossip mechanism by
...
TODO: concretely how this relates to ctor
