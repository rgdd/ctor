...
provided next in Section~\ref{sec:auditor:auditing}.

\subsubsection{Phase~3: Auditing} \label{sec:auditor:auditing}
...
\subsubsection{Phase~3: Auditor} \label{sec:ext-auditor:auditor}
