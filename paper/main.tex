...
\begin{document}
  ...
  \title{\huge CTor: Incremental Privacy-Preserving Certificate Transparency Support in Tor}
  \runningtitle{CTor: Incremental Privacy-Preserving Certificate Transparency Support in Tor}
  %\subtitle{...}
